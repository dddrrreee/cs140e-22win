...
In two windows:
   - `make srun`: wait until it starts printing `waiting for input`.
   - `make crun`: it will slowly get an IP address and connected, and 
     then both will start ping ponging values back.
