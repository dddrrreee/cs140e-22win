## CS140E: embedded operating systems (Engler, Winter, 2022)
...
Grading will be adjusted accordingly:
  - Final project: labs 65%, homework 10%, final project 15%,
    participation 10%.
...
Dawson Engler (engler) and Akshay Srivatsan (akshay01) and Alex Fu (afu625).
...
First things first: 
 ...
 2. Make sure you have access to the 
    [cs140e newsgroup](https://groups.google.com/g/cs140e-win22).  
    Email us if not!
